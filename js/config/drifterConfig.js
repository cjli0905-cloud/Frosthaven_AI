...
window.characterConfig = {
  ...
  // 戰術標籤
  "quick_tags": {
    "開戰佈局": "戰鬥將至。如果持續效果區為空，則優先建立持續效果。【盡量避免】浪費單次流失卡。",
    "快速移動": "急需長距離位移。選取高移動數值的卡牌。",
    "全力攻擊(單)": "將資源全數投入最高傷害。允許打出流失卡以造成毀滅打擊。",
    "全力攻擊(多)": "將資源全數投入範圍攻擊或多目標攻擊。允許打出流失卡以造成毀滅打擊。",
    "全力防守": "優先挑選能自補、再生 (Regenerate)、護盾 (Shield)、或防護 (Ward)的卡牌。",
